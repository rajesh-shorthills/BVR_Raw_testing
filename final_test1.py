...
def finalResult():
    ...
    data_review_flag =  countingReviews()[0]
    data_title_flag =  countingTitle()[0]
    data_features_flag =  countingFeatures()[0]
    data_rating_flag  =  countingRating()[0]
    data_totalRatings_flag  =  countingTotalRatings()[0]
    data_floatRating_flag =   floatRating()[0]
    data_nonRedrating_flag  =  countingNonRedReviews()[0]
