...
def ReadingFiles():
    ...
    return loaded_full_files, loaded_files, deepCopy_loaded_full_files, deepCopy_green_loaded_full_files, data_loaded_flag, not_loaded_files
...
def missingReviewText():
    ...
    for (eachFile, filename) in zip(ReadingFiles()[0], ReadingFiles()[1]):
...
def countingReviews():
    review_flag = []
    review_reason_flag = []    
    for eachFile in ReadingFiles()[0]:
    ...
    d = {"Name": ReadingFiles()[1], "review_flag": review_flag}
    d2 = {"Name":ReadingFiles()[1], "review_reason_flag": review_reason_flag}
...
def countingTitle():
    ...
    d = {"Name": ReadingFiles()[1], "title_flag": title_flag}
    d2 = {"Name": ReadingFiles()[1], "title_reason_flag": title_reason_flag}
...
def countingFeatures():
    ...
    d = {"Name": ReadingFiles()[1], "features_flag": features_flag}
    d2 = {"Name": ReadingFiles()[1], "features_reason_flag": features_reason_flag}
...
def countingRating():
    ...
    d = {"Name":ReadingFiles()[1], "rating_flag": rating_flag}
    d2 = {"Name": ReadingFiles()[1], "rating_reason_flag": rating_reason_flag}
...
def countingTotalRatings():
    ...
    d = {"Name":ReadingFiles()[1], "totalRatings_flag": totalRatings_flag}
    d2 = {"Name": ReadingFiles()[1], "totalRatings_reason_flag": totalRatings_reason_flag}
...
def floatRating():
    ...
    d = {"Name":ReadingFiles()[1], "floatRating_flag": floatRating_flag}
    d2 = {"Name":ReadingFiles()[1], "floatRating_reason_flag": floatRating_reason_flag}
...
def combiningNonRedReviews():
    ...
    wrong_FormatRating = wrongFormatRating()
    less_ReviewText = lessReviewText()
    new_loaded_full_files = ReadingFiles()[2]
    list_of_flags = []
    ...
    for eachList in (missing_ReviewText, missing_ReviewDate, missing_ReviewTitle, missing_ReviewerName, wrong_ReviewDate, missing_Rating, wrong_FormatRating, less_ReviewText):
        if eachList[1] == "Red":
            list_of_flags.append(eachList[0])
    list_of_flags = tuple(list_of_flags)
    for (filename, eachFile) in zip( ReadingFiles()[1], new_loaded_full_files):
...
def combiningGreenReviews():
    ...
    wrong_FormatRating = wrongFormatRating()
    less_ReviewText = lessReviewText()
    new_loaded_full_files = ReadingFiles()[3]
...
def countingNonRedReviews():
    ...
    for (filename, eachFile) in zip(ReadingFiles()[1], ReadingFiles()[0]):
    ...
    d = {"Name":ReadingFiles()[1], "nonRedRating_flag": nonRedRating_flag}
    d2 = {"Name":ReadingFiles()[1], "nonRedRating_reason_flag": nonRedRating_reason_flag}
...
def countingNonRedReviews2(): # does the same thing but doesn't keep the Red Reviews
    ...
    d = {"Name": ReadingFiles()[1], "nonRed_flag": nonRed_flag}
    d2 = {"Name": ReadingFiles()[1], "nonRed_reason_flag": nonRed_reason_flag}
...
def greenReviewDates():
    ...
    d = {"Name": ReadingFiles()[1], "countReviewDate_flag": countReviewDate_flag}
    d2 = {"Name": ReadingFiles()[1], "countReviewDate_reason_flag": countReviewDate_reason_flag}
...
def findingDuplicates():
    ...
    d = {"Name": ReadingFiles()[1], "duplicate_flag": duplicate_flag}
    d2 = {"Name":ReadingFiles()[1], "duplicate_reason_flag": duplicate_reason_flag}
...
def finalResult():
    ...
    if ReadingFiles()[5] != []:
        ...
        for not_loaded in ReadingFiles()[5]:
            test = df_final
